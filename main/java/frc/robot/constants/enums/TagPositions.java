...
public enum TagPositions {
  ...
  TagPositions(int id, double x, double y, double z, double yaw, double xShift, double yShift) {
    ...
    double xM = Units.inchesToMeters(x + xShift);
    double yM = Units.inchesToMeters(y + yShift);
    double zM = Units.inchesToMeters(z);
    double yawRad = Units.degreesToRadians(yaw);

    aprilTag = new AprilTag(id, new Pose3d(xM, yM, zM, new Rotation3d(0.0, 0.0, yawRad)));
  }
  ...
  public static final class Consts {
    ...
    public static final double SUBSTATION_Z_IN = 27.375,
                               SUBSTATION_ZM = Units.inchesToMeters(SUBSTATION_Z_IN);
  }
}
